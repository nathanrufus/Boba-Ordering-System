...
export default function MenuPage() {
  ...
  const rawCategories = useMemo(() => {
    ...
    return sortedCats.map((c) => ({
      ...c,
      items: [...(c.items || [])].sort((i1, i2) =>
        norm(i1?.name).localeCompare(norm(i2?.name))
      ),
    }));
  }, [data]);
    ...
    <div className="min-h-screen text-slate-900">
      ...
      <header className="sticky top-0 z-20 border-b border-slate-200 bg-white">
        <div className="w-full px-4 sm:px-6 lg:px-10 py-2">
          {/* Top row: left content + cart on the right */}
          <div className="flex items-center justify-between gap-3">
              ...
              <div className="min-w-0">
                ...
                <div className="mt-2 -mx-1 px-1">
                  ...
                  <div className="mt-2 flex items-center gap-2 overflow-x-auto whitespace-nowrap pb-1 sm:flex-wrap sm:overflow-visible sm:whitespace-normal">
                    ...
                    {/* WhatsApp (replaces Facebook icon) */}
                 <IconButton href={waLink} label="WhatsApp">
                   ...
                   <IconButton href={instagramUrl} label="Instagram">
                    ...
                    <IconButton href={tiktokUrl} label="TikTok">
                        <svg viewBox="0 0 24 24" aria-hidden="true" className="h-7 w-7">
                          {/* TikTok-ish cyan shadow */}
                          <path
                            d="M15 3c.6 3.2 2.7 5 6 5v3c-2.2 0-4.1-.7-6-2v7.2c0 3.3-2.7 5.8-6 5.8s-6-2.5-6-5.8c0-3.1 2.5-5.6 5.6-5.8V14c-1.3.2-2.3 1.3-2.3 2.6 0 1.5 1.2 2.7 2.7 2.7S12 18.1 12 16.6V3h3z"
                            fill="#25F4EE"
                            opacity="0.9"
                            transform="translate(-0.7,0.6)"
                          />
                          {/* TikTok-ish pink shadow */}
                          <path
                            d="M15 3c.6 3.2 2.7 5 6 5v3c-2.2 0-4.1-.7-6-2v7.2c0 3.3-2.7 5.8-6 5.8s-6-2.5-6-5.8c0-3.1 2.5-5.6 5.6-5.8V14c-1.3.2-2.3 1.3-2.3 2.6 0 1.5 1.2 2.7 2.7 2.7S12 18.1 12 16.6V3h3z"
                            fill="#FE2C55"
                            opacity="0.9"
            ...
            {/* RIGHT SIDE: Cart button at top */}
            <button
              onClick={() => setCartOpen(true)}
              className="rounded-2xl bg-slate-900 text-white px-4 py-2 text-sm sm:text-base font-extrabold shadow
                         hover:bg-slate-800 active:bg-slate-900 transition shrink-0"
            >
